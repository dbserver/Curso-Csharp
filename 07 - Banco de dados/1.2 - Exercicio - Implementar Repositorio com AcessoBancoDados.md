...
### 1. Definição da Entidade `Extrato` e rever IRepository ( Remover o metodo ObterPor(Func<t,bool>))
...
public class ExtratoRepository : IRepositorio<Extrato>
{
    ...
    public void Adicionar(Extrato extrato)
    {
        try
        {
            ...
            string sql = $"INSERT INTO Extrato (NumeroConta, NomeTitular) VALUES ('{extrato.NumeroConta}', '{extrato.NomeTitular}')";
            _acessoBancoDados.ExecutarInsert(sql);
    ...
    public void Atualizar(Extrato extrato)
    {
        try
        {
            ...
            string sql = $"UPDATE Extrato SET NumeroConta = '{extrato.NumeroConta}', NomeTitular = '{extrato.NomeTitular}' WHERE Id = {extrato.Id}";
            _acessoBancoDados.ExecutarInsert(sql);
            _acessoBancoDados.EfetivarComandos();
        }
        catch (Exception ex)
